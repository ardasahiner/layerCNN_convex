...
trainset_class = torchvision.datasets.CIFAR10(root='/mnt/raid3/sahiner/', train=True, download=True,transform=transform_train)
...
testset = torchvision.datasets.CIFAR10(root='/mnt/raid3/sahiner/', train=False, download=True, transform=transform_test)
...
n_cnn=args.ncnn
net = convexGreedyNet(block_conv, 1, args.feature_size, downsample=downsample, batchnorm=args.bn)
